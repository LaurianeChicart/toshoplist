...
class DepartmentFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $viandes_et_poissons = ["Poulet", "Blanc de poulet", "Escalope de dinde", "Steak", "Steak hâché", "Rôti de porc", "Saucisse", "Chipolata", "Merguez", "Jambon", "Blanc de dinde", "Jambon cru", "Saumon", "Saumon fumé", "Truite", "Truite fumée", "Thon", "Maquereau", "Sardines", "Colin", "Lieu", "Moules", "Crevettes", "Langoustines", "Huîtres", "Merlan "];
