 ...
 */
final class Version20190725142128 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ingredient ADD user_id INT DEFAULT NULL, DROP user');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ingredient ADD user INT NOT NULL, DROP user_id');
    }
}
